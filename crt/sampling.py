...
if __name__ == '__main__':
    ...
    parser.add_argument('--cpath', type=str,
        ...
        default = '../gen/gen40k_maccs.csv')
        
    parser.add_argument('--property_data', type=str,      
        #MACCS fingerprints of seed active analogs
    ...
    parser.add_argument('--vocab_size', type=int, 
                        #default = 79, #for  vocab_size=79
                        #default = 81, #for vocab_size=81
                        default = 76, #for ChEMBL
